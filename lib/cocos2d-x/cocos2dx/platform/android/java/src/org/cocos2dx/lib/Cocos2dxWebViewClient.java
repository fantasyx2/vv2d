...
public class Cocos2dxWebViewClient extends WebViewClient {
	...
	public Cocos2dxWebViewClient(WebView webView) {
		this(webView, null);
	}

	public Cocos2dxWebViewClient(WebView webView, WVJBHandler messageHandler) {
...
//			e.printStackTrace();
//		}
		String js = CocosWebViewJavascriptBridge.getJsBridgeCode();
		executeJavascript(js);
